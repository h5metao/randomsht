...
class Scoreboard:
	...
	def __init__(self, ai_game):
		"""Inicjalizacja atrybutów dottyczacych punktacji"""
	...
	def prep_score(self):
		...
		rounded_score = round(self.stats.score, -1) # -1 nakazuje do zaokrąglenia najbliższej wielokrotnosci 10, 100, 1000 itd
	...
	def prep_ships(self):
		"""Wyświetla liczbe statków, jakie pozostały graczowi."""
		self.ships = Group()
